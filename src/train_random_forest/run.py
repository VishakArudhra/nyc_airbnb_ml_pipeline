...
def go(args):
    ...
    # YOUR CODE HERE
    def export_model(run, pipe, used_columns, X_val, val_pred, export_artifact, metadata):
    ...
    # YOUR CODE HERE
    export_model(run, sk_pipe, processed_features, X_val, y_pred, args.output_artifact, rf_config)
    ######################################
